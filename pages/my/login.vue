	...
	<view class="register">
		...
		<view class="content">
			...
			<view class="border-bottom">
			  ...
			  <view class="send-vcode" @tap="getVerCode()"><text style="color: #ccc;margin-right: 3px;">|</text> 发送验证码</view>
			</view>
			
			<button type="primary" style="margin:20px" size="default">登入/注册</button>
		</view>
